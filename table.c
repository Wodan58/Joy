...
/* 1040 */ { Q0, OK, "stack", stack_, ".. X Y Z  ->  .. X Y Z [Z Y X ..]", "Pushes the stack as a list.\n" },
/* 1050 */ { Q0, OK, "__symtabmax", __symtabmax_, "->  I", "Pushes value of maximum size of the symbol table.\n" },
/* 1060 */ { Q0, OK, "__symtabindex", __symtabindex_, "->  I", "Pushes current size of the symbol table.\n" },
/* 1070 */ { Q0, OK, "__dump", __dump_, "->  [..]", "debugging only: pushes the dump as a list.\n" },
/* 1080 */ { Q0, OK, "conts", conts_, "->  [[P] [Q] ..]", "Pushes current continuations. Buggy, do not use.\n" },
/* 1090 */ { Q0, OK, "autoput", autoput_, "->  I", "Pushes current value of flag for automatic output, I = 0..2.\n" },
/* 1100 */ { Q0, OK, "undeferror", undeferror_, "->  I", "Pushes current value of undefined-is-error flag.\n" },
/* 1110 */ { Q0, OK, "undefs", undefs_, "->  [..]", "Push a list of all undefined symbols in the current symbol table.\n" },
/* 1120 */ { Q0, OK, "echo", echo_, "->  I", "Pushes value of echo flag, I = 0..3.\n" },
...
/* 2180 */ { Q0, OK, "intern", intern_, "\"sym\"  ->  sym", "Pushes the item whose name is \"sym\".\n" },
/* 2190 */ { Q0, OK, "body", body_, "U  ->  [P]", "Quotation [P] is the body of user-defined symbol U.\n" },
...
/* 2960 */ { Q0, OK, "__manual_list", __manual_list_, "->  L", "Pushes a list L of lists (one per operator) of three documentation strings.\n" },
...
/* 3010 */ { Q0, OK, "gc", gc_, "->", "[IMPURE] Initiates garbage collection.\n" },
/* 3020 */ { Q0, IGNORE_POP, "system", system_, "\"command\"  ->", "[IMPURE] Escapes to shell, executes string \"command\".\nThe string may cause execution of another program.\nWhen that has finished, the process returns to Joy.\n" },
/* 3030 */ { Q0, OK, "getenv", getenv_, "\"variable\"  ->  \"value\"", "Retrieves the value of the environment variable \"variable\".\n" },
/* 3040 */ { Q0, OK, "argv", argv_, "->  A", "Creates an aggregate A containing the interpreter's command line arguments.\n" },
/* 3050 */ { Q0, OK, "argc", argc_, "->  I", "Pushes the number of command line arguments. This is quivalent to 'argv size'.\n" },
...
/* 3110 */ { Q0, OK, "include", include_, "\"filnam.ext\"  ->", "Transfers input to file whose name is \"filnam.ext\".\nOn end-of-file returns to previous input file.\n" },
...
/* 3150 */ { Q0, OK, "casting", casting_, "X Y  ->  Z", "[EXT] Z takes the value from X and uses the value from Y as its type.\n" },
...
/* 3180 */ { Q0, OK, "over", over_, "X Y  ->  X Y X", "[EXT] Pushes an extra copy of the second item X on top of the stack.\n" },
/* 3190 */ { Q0, OK, "pick", pick_, "X Y Z 2  ->  X Y Z X", "[EXT] Pushes an extra copy of nth (e.g. 2) item X on top of the stack.\n" },
/* 3200 */ { Q0, OK, "round", round_, "F  ->  G", "[EXT] G is F rounded to the nearest integer.\n" },
/* 3210 */ { Q0, OK, "sametype", sametype_, "X Y  ->  B", "[EXT] Tests whether X and Y have the same type.\n" },
/* 3220 */ { Q0, OK, "typeof", typeof_, "X  ->  I", "[EXT] Replace X by its type.\n" },
/* 3230 */ { Q0, IGNORE_POP, "unassign", unassign_, "[N]  ->", "[IMPURE] Sets the body of the name N to uninitialized.\n" },
/* 3240 */ { Q1, OK, "#genrec", genrecaux_, "[[B] [T] [R1] R2]  ->  ...", "Executes B, if that yields true, executes T.\nElse executes R1 and then [[[B] [T] [R1] R2] genrec] R2.\n" },
/* 3250 */ { Q1, OK, "#treegenrec", treegenrecaux_, "T [[O1] [O2] C]  ->  ...", "T is a tree. If T is a leaf, executes O1.\nElse executes O2 and then [[[O1] [O2] C] treegenrec] C.\n" },
/* 3260 */ { Q1, OK, "#treerec", treerecaux_, "T [[O] C]  ->  ...", "T is a tree. If T is a leaf, executes O. Else executes [[[O] C] treerec] C.\n" },
